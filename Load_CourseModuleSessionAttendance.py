...
object = 'course_module_session_attendance'
object_db = 'LITMOS.COURSE_MODULE_SESSION_ATTENDANCE'
...
table_list = cursor.execute('COPY INTO LITMOS.COURSE_MODULE_SESSION_ATTENDANCE '
                            '(COURSE_ID'
                            ',COURSE_MODULE_ID'
                            ',USER_ID'
                            ',EVENT_STATUS'
